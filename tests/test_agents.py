...
class TestWebAgent:
    ...
    def test_web_agent_creation(self, api_client):
        ...
        assert "web-search-agent" in [agent.get("agent_id") for agent in agents]

    def test_web_agent_search_query(self, api_client):
    ...
    def test_web_agent_conversation_history(self, api_client):
